    ...
    const datas = [
        {
            icon: AptosIcon,
            asset: 'APT',
            depositAPY: trim((poolInfo.aptos.totalBorrow * 0.2) / poolInfo.aptos.totalDeposit * 100, 3),
            borrowAPY: 20,
            ...
            icon: ArcoIcon,
            asset: 'ARC',
            depositAPY: trim((poolInfo.arc.totalBorrow * 0.2) / poolInfo.arc.totalDeposit * 100, 3),
            borrowAPY: 20,
                        ...
                        <TableBody>
                            {datas.map((item, index) => (
                                ...
                                >
                                    ...
                                    <TableCell>{item.borrowAPY}%</TableCell>
